...
# Create skillset with Knowledge Store for chunk projection
...
echo "Creating chunk-level skillset with Knowledge Store..."
...
# Create new skillset with chunking and Knowledge Store
curl -X PUT \
  "https://srch-rag-conf.search.windows.net/skillsets/confluence-chunk-skillset?api-version=2023-11-01" \
  -H "api-key: $SEARCH_ADMIN_KEY" \
